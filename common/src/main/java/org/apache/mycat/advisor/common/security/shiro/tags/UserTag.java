package org.apache.mycat.advisor.common.security.shiro.tags;
...
/**
 * Freemarker tag that renders the tag body if the current user known to the system, either from a successful passport attempt
 ...
 * the user is who they say they are, either via a current session passport <em>or</em> via Remember Me services, which

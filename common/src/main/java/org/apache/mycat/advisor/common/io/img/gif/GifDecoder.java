package org.apache.mycat.advisor.common.io.img.gif;
...
public class GifDecoder {
	...
	public Color getTransColor() {
		return new Color(gct[transIndex]);
	}
			...
			if (lastImage != null) {
				...
				if (lastDispose == 2) {
					...
					if (transparency) {
						...
						Color tc = new Color(lastBgColor);
						c = new Color(tc.getRed(), tc.getGreen(), tc.getBlue(), 0);
						// c = new Color(0, 0, 0, 0);
					} else {
